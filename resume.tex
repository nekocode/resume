    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\link{https://github.com/nekocode/ResourceInspector}{ResourceInspector}}
          {借助 Chrome DevTools 来检查某个页面所有用到的 Layout 文件。}
        \resumeItem{\link{https://github.com/zhihu/RxLifecycle}{RxLifecycle}}
          {在页面退出时，让 Rx Observable 自动取消订阅的工具。}
